...
from src import find_accessible_surface, get_accessible_mesh, plot_mesh_mask
# from src import load_step, plot_mesh_with_projections, get_2d_mask, plot_mesh_mask
